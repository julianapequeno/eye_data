...
expName = 'first_experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/home/juliana/Documents/EYEtracking-gitrepo/eye_data/psychopy-experiments/first_experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    calibrationTarget = visual.TargetStim(win, 
        ...
        radius=0.01, fillColor=[0.7725, -0.6549, -0.2784], borderColor='black', lineWidth=2.0,
        innerRadius=0.0035, innerFillColor='green', innerBorderColor='black', innerLineWidth=2.0,
        colorSpace='dkl', units=None
    )
    # define parameters for calibration
    calibration = hardware.eyetracker.EyetrackerCalibration(win, 
        eyetracker, calibrationTarget,
        units=None, colorSpace='dkl',
        progressMode='time', targetDur=1.5, expandScale=1.5,
        targetLayout='NINE_POINTS', randomisePos=True, textColor=[-0.2784, -0.6549, -0.2784],
    ...
    while continueRoutine and routineTimer.getTime() < 5.0:
        ...
        if etRecord.status == STARTED:
            ...
            if tThisFlipGlobal > etRecord.tStartRefresh + 5.0-frameTolerance:
