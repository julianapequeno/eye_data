### Example taken from StackOverflow. Not mine.
## Here you can see the link for it: https://stackoverflow.com/questions/60276164/how-to-draw-eye-gaze-data-from-eye-tracker-by-pyqt-while-a-video-is-playing

import os
import time

from PyQt5 import QtCore, QtGui, QtWidgets, QtMultimedia, QtMultimediaWidgets
from tobiiresearch.implementation import EyeTracker as et
import numpy as np
...
class EyeTracker(QtCore.QObject):
    ...
    def start(self):
        self.tracker.subscribe_to(
            et.EYETRACKER_GAZE_DATA, self._callback, as_dictionary=True
        )
...
class Widget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        # get eye tracker
        eyetrackers = et.find_all_eyetrackers()
